...
CREATE TABLE IF NOT EXISTS public.hn_daily (
    ...
    summary TEXT,
    url TEXT,
    embedding extensions.vector (768), -- 使用完整的 schema 名稱 extensions.vector
...
CREATE INDEX IF NOT EXISTS hn_daily_embedding_idx ON public.hn_daily USING hnsw (embedding extensions.vector_cosine_ops);
